...
// Route handler for creating new tasks
...
// Route Handler for fetching an individual task
...
router.delete('/tasks/:id', auth, async (req, res) => {
   try {
      ...
      res.send(task); // delete successful
   } catch (e) {
      res.status(500).send();
   }
});
